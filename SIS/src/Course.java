...
public class Course implements Comparable<Course> {
    ...
    public String toString() {
        return "Course{id=" + this.getId() + ", name=" + this.getName() + ", level=" + this.getLevel() + ", professor="
                + this.getProfessor() + ", students=" + this.getStudents() + "}";
    }
    ...
    public static void main(String[] args) {
        ...
        for(Course course : courseMap.keySet()){
            if(courseMap.get(course).equals("A")){
